...
const navİtems = document.querySelectorAll("header nav a");

// navİtems[0].textContent = siteContent["nav"]["nav-item-1"];
// navİtems[1].textContent = siteContent["nav"]["nav-item-2"];
// navİtems[2].textContent = siteContent["nav"]["nav-item-3"];
// navİtems[3].textContent = siteContent["nav"]["nav-item-4"];
// navİtems[4].textContent = siteContent["nav"]["nav-item-5"];
// navİtems[5].textContent = siteContent["nav"]["nav-item-6"];

// navİtems[0].setAttribute("class","italic");
// navİtems[1].setAttribute("class","italic");
// navİtems[2].setAttribute("class","italic");
// navİtems[3].setAttribute("class","italic");
// navİtems[4].setAttribute("class","italic");
// navİtems[5].setAttribute("class","italic");

navİtems.forEach((item,index) => {
  let j = index + 1
